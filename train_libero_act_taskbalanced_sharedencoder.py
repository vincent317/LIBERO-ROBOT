#!/usr/bin/env python3
"""Train a multitask ACT variant with a shared task embedding and balanced per-task batches."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("/home/ec2-user/libero_test/outputs/libero_act_libero_spatial_multitask_taskbalanced_sharedencoder"),
    )
    ...
    parser.add_argument("--run-name", default="act_taskbalanced_sharedencoder")
...
def main() -> None:
    ...
    config = ACTTaskIDSharedEncoderConfig(
    ...
    policy = ACTTaskIDSharedEncoderPolicy(config).to(device)
    ...
    save_json(
        {
            ...
            "policy_type": ACTTaskIDSharedEncoderPolicy.name,
        },
